...
const Lastfm = () => {
  return(
      <main className="app__content app__content--text">
        <h2>Why Last.fm?</h2>
        ...
        <p>Also, the Last.fm API does not require an OAuth access token. For more information about Last.fm, visit Last.fm.</p>
      </main>
  );
};
